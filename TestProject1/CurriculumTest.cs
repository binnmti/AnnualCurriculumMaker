...
namespace TestProject1
{
    public class CurriculumTest
    {
        ...
        public void Curriculum‚ğƒeƒXƒg()
        {
            ...
            curriculum[0, 0] = new CurriculumCell(lesson, new List<string> { "â–{", "¼ˆä", }, 0);
        ...
        public void Curriculum‚ğTeacher‚É•ÏŠ·()
        {
            ...
            curriculum[0, 0] = new CurriculumCell(‘Œê, new List<string> { "â–{", "¼ˆä", }, 0);
            curriculum[0, 1] = new CurriculumCell(Z”, new List<string> { "¼ˆä", }, 0);
            curriculum[0, 2] = new CurriculumCell(—‰È, new List<string> { "¼ˆä", }, 0);
            curriculum[0, 3] = new CurriculumCell(Ğ‰ï, new List<string> { "¼ˆä", }, 0);
